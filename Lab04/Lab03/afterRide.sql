...
ALTER TABLE registro 
ADD CONSTRAINT CHK_fotos_registro 
CHECK (
    fotos LIKE 'www.%.gif' OR fotos LIKE 'www.%.pdf' 
);
...
ALTER TABLE registro 
ADD CONSTRAINT FK_correspondeA_registro 
FOREIGN KEY (correspondeA) REFERENCES version(id) 
ON DELETE CASCADE;
